...
- Training JSONL: 
  ...
  Notes: WhatsApp-filtered persona conversations in OpenAI chat format.
...
3) Create fine-tuning job on base model (ft:gpt-4o-mini-2024-07-18:personal:arjun-voice-v1:C1oFx9M6) with SFT.
...
- Base model: ft:gpt-4o-mini-2024-07-18:personal:arjun-voice-v1:C1oFx9M6 (cost-efficient).
- Method: Supervised Fine-Tuning (SFT)
- Epochs, batch size, learning rate multiplier: auto

USAGE:
  export OPENAI_API_KEY=... && python3 openai_fine_tuning_two_stage.py

VERSION HISTORY:
- 2.1 (2025-08-08): Documentation overhaul; clarified inputs/outputs, meters,
  and base model set to ft:gpt-4o-mini-2024-07-18:personal:arjun-voice-v1:C1oFx9M6.
- 2.0 (2025-08-07): Switched base model from gpt-4o to ft:gpt-4o-mini-2024-07-18:personal:arjun-voice-v1:C1oFx9M6 to avoid
...
# File paths
# Use WhatsApp-converted OpenAI chat files as inputs
...
MODEL_INFO_FILE = "arjun_voice_model_info_two_stage.json"
LOG_FILE = "fine_tuning_log_two_stage.txt"
DATASET_STATS_FILE = "/Users/macbook2024/Dropbox/AAA Backup/A Working/Arjun LLM Writing/persona_dataset_stats.json"

# Fine-tuning configuration
BASE_MODEL = "ft:gpt-4o-mini-2024-07-18:personal:arjun-voice-v1:C1oFx9M6"  # Cheaper GPT-4o mini (July 2024) for cost-efficient fine-tuning
MODEL_SUFFIX = "arjun-voice-two_stage"        # Identifier for the fine-tuned model (v2 for GPT-4o)
